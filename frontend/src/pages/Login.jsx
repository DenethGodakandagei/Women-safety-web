        ...
        <div className="min-h-screen theme-dark flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="glass rounded-[60px] p-12 lg:p-16 border-white/80 bg-white/70 shadow-[0_80px_160px_-40px_rgba(0,0,0,0.1)]">
                    <div className="mb-14 text-center">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/5 border border-accent/10 mb-8">
                           ...
                           <span className="text-[10px] font-bold text-accent uppercase tracking-[3px]">Secure Authentication</span>
                        </div>
                        <h1 className="text-5xl lg:text-6xl font-medium tracking-[-0.06em] mb-4 text-text font-display">Welcome <br /> <span className="opacity-20 font-light tracking-tighter italic">back.</span></h1>
                        <p className="text-text-secondary text-xl font-light leading-relaxed tracking-tight">Access your security sentinel.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-12">
                        ...
                        <div className="group">
                            <div className="flex justify-between items-center px-1 mb-4">
                                <label className="block text-[11px] font-bold text-text uppercase tracking-[4px] opacity-40">Encryption Key</label>
                                <a href="#" className="text-[11px] font-bold text-accent/60 hover:text-accent transition-colors uppercase tracking-[2px]">Lost Access?</a>
                            </div>
                            <div className="relative">
                                <span className="absolute left-6 top-1/2 -translate-y-1/2 text-text-secondary opacity-40 group-focus-within:opacity-100 transition-opacity">
                        ...
                        <div className="pt-4">
                            ...
                            >
                                ...
                                <span className="text-[20px] font-bold tracking-tight">
                                   {loading ? 'Authenticating...' : 'Initialize Sentinel'}
                                </span>
                ...
                <div className="mt-16 text-center">
                    <p className="text-text-secondary text-[16px] font-medium tracking-tight opacity-40 mb-4">New to the network?</p>
                    <Link to="/register" className="glass px-8 py-3 rounded-2xl text-accent font-bold hover:bg-accent hover:text-white transition-all border-accent/10 hover:border-accent shadow-lg shadow-accent/5">
                       Register Device.
                    </Link>
                </div>
            </motion.div>
